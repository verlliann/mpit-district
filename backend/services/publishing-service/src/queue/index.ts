...
let publishingQueueEvents: QueueEvents;
...
export async function initializeQueue(): Promise<void> {
  ...
  publishingQueueEvents = new QueueEvents('publishing', { connection });
...
export function getPublishingQueueEvents(): QueueEvents {
  return publishingQueueEvents;
}
